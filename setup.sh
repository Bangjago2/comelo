...
TIMES="10"
CHATID="5010568875"
KEY="7343462742:AAEIXQwdNjlqjpXj5j2jK-t7_J6x9LzCM_A"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SRICPT VPN              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/Bangjago2/permisi//main/ip"
rm -f /usr/bin/user
...
wget https://raw.githubusercontent.com/Bangjago2/comelo/main/Cdy/menu.zip
unzip menu.zip
chmod +x menu/*
